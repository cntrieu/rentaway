    ...
    const uploadPhoto = (e) => {
        ...
        axios.post('http://localhost:3001/upload', data, {
            ...
            setClothing(prevClothing => ({
                ...prevClothing,
                images: [...prevClothing.images, ...filenames]
            }));
    ...
    <div className="w-9/12 mx-auto flex-grow m-5">
        ...
        <div className="">
            <form onSubmit={onSubmit}>
                ...
                <div className="text-2xl mt-4">
                    ...
                    {addedPhotos.length > 0 && addedPhotos.map(link => (
                        ...
                        <div key={link} className="h-32 flex"> 
                            <img className="rounded-2xl" src={`http://127.0.0.1:3001/uploads/${link}`} alt={`Uploaded Image`} style={{ maxWidth: '200px', maxHeight: '200px' }} />
                        </div>
                    ))}

                        <label className="h-32 cursor-pointer flex gap-1 justify-center border bg-transparent rounded-2xl p-8 text-2xl text-gray-600" type="button">
                ...
                <button type="submit" className="border rounded-lg w-full border-orange-900 bg-amber-700 text-white p-3 mb-6">Create Listing</button>
            </form>
        </div>
    </div>
    )
